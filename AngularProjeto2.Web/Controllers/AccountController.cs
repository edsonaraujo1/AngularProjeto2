...
using AngularProjeto2.Sessions;
using AngularProjeto2.Web.Controllers.Results;
using AngularProjeto2.Web.Models;
using AngularProjeto2.Web.Models.Account;
...
{
    public class AccountController : AngularProjeto2ControllerBase
    {
